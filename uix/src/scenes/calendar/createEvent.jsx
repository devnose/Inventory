...
const CreateEvent = ({openVar , onClose, onDelete, selected, time}) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const eventData = { title, location, startTime, endTime, description, category, isRepeating };
    ...
    return (
        ...
        >
          ...
          <div className="modal-actions">
            <button type="submit" onClick={handleSubmit} className="btn btn-primary">Save Event</button>
            <button type="button" onClick={onClose} className="btn btn-secondary">Cancel</button>
            {/* <button type="button" onClick={handleDelete} className="btn btn-danger">Delete Event</button> */}
          </div>
          </div>
